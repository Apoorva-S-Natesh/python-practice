...
urlpatterns = [
	...
	path('open_add_restaurant', views.open_add_restaurant, name="open_add_reataurant"),
	...
	path('open_update_item/<int:item_id>', views.open_update_item, name='open_update_item'),
	...
	path('delete_item_from_cart/<str:username>/<int:item_id>', views.delete_item_from_cart, name='delete_item_from_cart'),
